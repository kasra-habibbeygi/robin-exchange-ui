...
const SvgBoldHome = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' fill='currentColor' viewBox='0 0 512 512' {...props}>
