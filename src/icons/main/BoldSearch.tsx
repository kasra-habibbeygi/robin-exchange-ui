...
const SvgBoldSearch = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' viewBox='0 0 513.749 513.749' width='1em' height='1em' {...props}>
